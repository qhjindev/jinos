...
main(void)
{
  ...
  printf(2, "open console\n");

  // Assumes three file descriptors open.
  while((fd = open((char*)"console", O_RDWR)) >= 0){
    if(fd >= 3){
      close(fd);
      break;
    }
